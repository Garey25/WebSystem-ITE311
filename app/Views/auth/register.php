        ...
        <div class="auth-card">
                ...
                <div class="logo-section">
                    <div class="logo-icon">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M20 8V14L23 17L20 20V21H13" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>
                    </div>
            ...
            <div class="auth-footer">
                <p class="signup-text">
                    ...
                    <a href="<?= base_url('login') ?>" class="signup-link">Sign In</a>
                </p>
            </div>
        </div>
    </div>
