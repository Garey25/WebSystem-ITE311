...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
    <div>
        <h1 class="fw-bold mb-1">Admin Search</h1>
        <p class="text-muted mb-0">Search users, courses, enrollments, and materials.</p>
    </div>

    <form class="d-flex gap-2" method="get" action="<?= site_url('admin/search') ?>" style="min-width: 320px;">
        <input
            type="text"
            class="form-control"
            name="q"
    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-sm btn-outline-primary" href="<?= site_url('admin/users') ?>">Manage Users</a>
            </div>
            <div class="card-body">
    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a class="btn btn-sm btn-outline-primary" href="<?= site_url('admin/courses') ?>">Manage Courses</a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
